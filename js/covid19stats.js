				...
				dom_element += '<div class="covid__content">';
					dom_element += '<div class="covid__stats">';
						...
						if(settings.showCases) {
							dom_element += '<div class="covid__stat cases">' + formatNumber(cases) + '<span>Zakażonych</span></div>';
						}
						
						if(settings.showDeaths) {
							dom_element += '<div class="covid__stat deaths">' + formatNumber(deaths) + '<span>Zmarłych</span></div>';
						}
						
						if(settings.showRecovered) {
							dom_element += '<div class="covid__stat recovered">' + formatNumber(recovered) + '<span>Wyleczonych</span></div>';
						}
